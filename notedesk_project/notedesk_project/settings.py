"""
Django settings for notedesk_project project.
...
SECRET_KEY = 'django-insecure-7($^&ps6wy=hx2a7qw9wcv&f+=%rp&)zs6i!#))1f$5gv$)v$m'
...
ROOT_URLCONF = 'notedesk_project.urls'
...
WSGI_APPLICATION = 'notedesk_project.wsgi.application'
